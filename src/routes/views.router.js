...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      console.log('page');
      console.log(page);
      //const parametros  = {page: page};
      // Construye la URL con los parámetros de req.query
      //const apiUrl = `http://localhost:${config.port}/api/products?limit=${limit}&page=${page}&query=${query}&sort=${sort}`;

      // Realiza la petición a la API con la URL construida
